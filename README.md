...
# [Available components](https://react-ui-git-dev-storyofams.vercel.app/)

| component                                                                                                    | description                                                                                                                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [Accordion](https://react-ui-git-dev-storyofams.vercel.app/?path=/story/components-accordion--basic)         | Vertically stacked list of items that can be collapsed/expanded individually                                                                                                                                                                                                   |
| [Box](https://react-ui-git-dev-storyofams.vercel.app/?path=/story/components-box--basic)                     | The base for all components                                                                                                                                                                                                                                                    |
| [Breadcrumb](https://react-ui-git-dev-storyofams.vercel.app/?path=/story/components-breadcrumb--basic)       | Shows the current path with the ability to navigate to each sub-path individually                                                                                                                                                                                              |
| [Button](https://react-ui-git-dev-storyofams.vercel.app/?path=/story/components-button--primary)             | Simple button component (see storybook for the most up to date variants)                                                                                                                                                                                                       |
| [Checkbox](https://react-ui-git-dev-storyofams.vercel.app/?path=/story/components-checkbox--basic)           | Checkbox with label and an optional statusmessage (optimized for usage with react-hook-form)                                                                                                                                                                                   |
| [DatePicker](https://react-ui-git-dev-storyofams.vercel.app/?path=/story/components-DatePicker--basic)       | Datepicker that utilizes 'react-flatpickr'                                                                                                                                                                                                                                     |
| [Flex](https://react-ui-git-dev-storyofams.vercel.app/?path=/story/components-flex--basic)                   | Mimics a `flexbox` implementation                                                                                                                                                                                                                                              |
| [Grid](https://react-ui-git-dev-storyofams.vercel.app/?path=/story/components-grid--basic)                   | Mimics a `grid` implementation using flexbox for compatibility reasons (with few limitations in comparison to the actual grid spec)                                                                                                                                            |
| [Heading](https://react-ui-git-dev-storyofams.vercel.app/?path=/story/components-heading--basic)             | Semantically correct headings (see storybook for all default variants)                                                                                                                                                                                                         |
| [Icon](https://react-ui-git-dev-storyofams.vercel.app/?path=/story/components-icon--library)                 | Allows for svgs to be used as icon. We also provide some default icons you can choose to import and use with the icon component (see storybook for a complete overview). *Note: please consider using something like [SVGR](https://react-svgr.com/) when using your own icons |
| [Input](https://react-ui-git-dev-storyofams.vercel.app/?path=/story/components-input--basic)                 | Input box with label and an optional statusmessage (optimized for usage with react-hook-form)                                                                                                                                                                                  |
| [Modal](https://react-ui-git-dev-storyofams.vercel.app/?path=/story/components-modal--basic)                 | Modal build with `reach-dialog` which uses framer-motion to ensure smooth state transition animations                                                                                                                                                                          |
| [Radio](https://react-ui-git-dev-storyofams.vercel.app/?path=/story/components-radio--basic)                 | Radio group with labels and an optional statusmessage (optimized for usage with react-hook-form)                                                                                                                                                                               |
| [Select](https://react-ui-git-dev-storyofams.vercel.app/?path=/story/components-select--basic)               | Select (created with `react-select`) input with label and an optional statusmessage (optimized for usage with react-hook-form)                                                                                                                                                 |
| [Spinner](https://react-ui-git-dev-storyofams.vercel.app/?path=/story/components-spinner--basic)             | Indicator to display a loading state                                                                                                                                                                                                                                           |
| [Stack](https://react-ui-git-dev-storyofams.vercel.app/?path=/story/components-stack--basic)                 | Automagically creates a (horizontal or vertical) stack of items with evenly spaced                                                                                                                                                                                             |
| [StatusMessage](https://react-ui-git-dev-storyofams.vercel.app/?path=/story/components-statusmessage--basic) | Displays a message in a certain colour based on the type of status (default, warning, error, success)                                                                                                                                                                         |
| [Tag](https://react-ui-git-dev-storyofams.vercel.app/?path=/story/components-tag--basic)                     | Tag component used to create a list of toggleable tags with an optional statusmessage (optimized for usage with react-hook-form)                                                                                                                                               |
| [Text](https://react-ui-git-dev-storyofams.vercel.app/?path=/story/components-text--basic)                   | Semantically correct text blocks (see storybook for all default variants)                                                                                                                                                                                                      |
| [TextArea](https://react-ui-git-dev-storyofams.vercel.app/?path=/story/components-textarea--basic)           | Text area with label and an optional statusmessage (optimized for usage with react-hook-form)                                                                                                                                                                                  |
| [Toggle](https://react-ui-git-dev-storyofams.vercel.app/?path=/story/components-toggle--basic)               | Toggle with label and an optional statusmessage (optimized for usage with react-hook-form)                                                                                                                                                                                     |
...
### Icons
We export a list of commonly used icons to get started quickly which you can view [here](https://react-ui-git-dev-storyofams.vercel.app/?path=/story/components-icon--library). Besides the icons we provide you can also supply your own svg to the Icon component as a React component. This recommended way of adding icons to load them into your application is by using [svgr](https://react-svgr.com/).
