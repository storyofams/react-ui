...
## Setup
You can get started right away by importing whichever component you fancy into your project, however to get the best DX keep reading!
...
```
### Custom components (outdated) /** FIX **/
